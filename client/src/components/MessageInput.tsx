...
export default function MessageInput() {
    ...
    //     if (!file) return; //  kiểm tra nếu người dùng không chọn file nào
    ...
    const handleSendMessage = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (imageFile) form.append("image", imageFile); // <-- tên field "image" khớp multer
    ...
    return (
        ...
        <div className="p-4 w-full">
            ...
            <form onSubmit={handleSendMessage} className="flex items-center gap-2">
                ...
                <button type="submit" className="btn btn-sm btn-circle" disabled={!text.trim() && !imageFile}>
                    <Send size={22} />
                </button>
            </form>
        </div>
